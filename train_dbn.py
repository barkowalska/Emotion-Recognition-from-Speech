...
X_train, X_test =preprocess_frames(directory)


model=DBN(X_train.shape[1], (64, 32, 16), 5, 1)
model.train(data=X_train, epochs=10, batch_size=32, learning_rate=0.001, momentum=0.1)
epochs=10
batch_size=128
learning_rate=0.001
